...
export function Header() {
  return (
    <>
      {/* Banner de aviso de versión de pruebas */}
      <div style={{
        ...
        <span>
          <strong>Versión de pruebas:</strong> Si algún abridor no aparece, se debe a que el partido aún se encuentra en estado de previa.
        </span>
      </div>
